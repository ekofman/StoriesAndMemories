...
#   - transcript_file: path to the transcript file (English)
...
config_dict = {
    ...
    "RositaIntervew4_11_20-4_11_20": {
        "page_id": "RositaIntervew4_11_20-4_11_20",
        "transcript_file": "transcripts/RositaIntervew4_11_20-4_11_20_English.txt",
        "audio_file": "audio/RositaIntervew4_11_20-4_11_20.mp3",
        "output_file": "RositaIntervew4_11_20-4_11_20.html",
...
main_points_dict = {
    ...
    },
    {
        ...
        "subtitle": "Rosita explains that the ship arrived carrying her mother's two sisters, her uncle Fabel, and Chelis’s family—all arriving together.",
        "start_time": 13,
    ...
    },
    {
        ...
        "subtitle": "She recalls that family meetings for birthdays, anniversaries, etc. were common and notes that they were all poorer (there were no cars).",
        "start_time": 52,
    ...
    },
    {
        ...
        "subtitle": "Rosita explains that everyone lived only 6–8 blocks apart in the same neighborhood where walking or taking the tram was normal.",
        "start_time": 85,
    ...
    },
    {
        ...
        "subtitle": "She mentions the traumatic transfer from Concepción to Santiago after the earthquake.",
        "start_time": 125,
    ...
    },
    {
        ...
        "subtitle": "Rosita refers to a cousin (son of 'the VINE') and to Jaime Motlis, who was already working as a doctor for the government.",
        "start_time": 155,
    ...
    },
    {
        ...
        "subtitle": "She explains that transport along Chile was done by train because there were few cars and paved roads.",
        "start_time": 209,
    ...
    },
    {
        ...
        "subtitle": "Rosita recounts living together in two very big houses—with the Aichelis and her mom’s sisters—with both fear and happiness.",
        "start_time": 246,
    ...
    },
    {
        ...
        "subtitle": "She explains how the 'grines' (gringos) fresh off the boat became a topic of discussion in the neighborhood.",
        "start_time": 330,
    ...
    },
    {
        ...
        "subtitle": "Rosita recalls Aunt Feige and mentions that she lived among these people from age 9 until her marriage.",
        "start_time": 406,
    ...
    },
    {
        ...
        "subtitle": "She recalls the January earthquake and that they slept in tents at a pool house called 'Penco.'",
        "start_time": 440,
    ...
    },
    {
        ...
        "subtitle": "Rosita describes seeing cracks, ditches, and a hole in the ground, wondering if it was related to a tsunami in Pucon, and referencing the 1939 Chilean earthquake.",
        "start_time": 501,
    ...
    },
    {
        ...
        "subtitle": "She recalls the first house on Agustinas—one that is still standing—and mentions passing by it.",
        "start_time": 588,
    ...
    },
    {
        ...
        "subtitle": "A discussion about central Santiago, including Plaza Italia, Ahumada, and Plaza de Armas, where everyone was close enough to walk or take the tram.",
        "start_time": 630,
    ...
    },
    {
        ...
        "subtitle": "She mentions that a synagogue was sold and installed in a church and recalls attending a Rosh Hashanah ceremony.",
        "start_time": 728,
    ...
    },
    {
        ...
        "subtitle": "Rosita shares details about her mother’s dramatic life—arriving in Chile in 1928, being born in 1929, and facing hardships.",
        "start_time": 783,
    ...
    },
    {
        ...
        "subtitle": "She recounts how her mother left for Puerto Montt (with help from her uncle Aaron) and met Jose Graver on the boat.",
        "start_time": 865,
    ...
    },
    {
        ...
        "subtitle": "She discusses how the family moved from Plaza Italia and invested in real estate (mentioning 'Lockshins').",
        "start_time": 964,
    ...
    },
    {
        ...
        "subtitle": "Rosita explains that after being widowed, her mother set up a new fabric factory and later tried to restart a workshop after divorce.",
        "start_time": 1034,
    ...
    },
    {
        ...
        "subtitle": "More details about investments, selling properties for low prices, and the financial challenges her mother faced.",
        "start_time": 1123,
    ...
    },
    {
        ...
        "subtitle": "Rosita recounts her mother’s marriage to a Polish man named Poniatyk and related details.",
        "start_time": 1179,
    ...
    },
    {
        ...
        "subtitle": "Discussion of how the dollar skyrocketed, property investments, and the use of the term 'Loxxion' for dollars.",
        "start_time": 1380,
    ...
    },
    {
        ...
        "subtitle": "Reflections on how her mother managed to start a business on her own despite numerous challenges.",
        "start_time": 1576,
    ...
    },
    {
        ...
        "subtitle": "Narrative regarding her mother’s divorce, the sale of the factory, and related financial decisions.",
        "start_time": 1774,
    ...
    },
    {
        ...
        "subtitle": "Explaining how the dollar skyrocketed and properties were sold for very little.",
        "start_time": 1860,
        "display_time": "0:31:00"
    },
    {
        ...
        "subtitle": "A continued discussion on the family business and investments.",
        "start_time": 1896,
    ...
    },
    {
        ...
        "subtitle": "Discussion of her mother's origins, life in Russia, the Crimean War reference, and immigrant background.",
        "start_time": 2042,
    ...
    },
    {
        ...
        "subtitle": "Final remarks on writing a book about immigration to South America, future research, and concluding thoughts.",
        "start_time": 2156,
...
# === Function to Generate a Single HTML Page for an Interview with Navigation ===
def generate_page_with_nav(config, main_points_list, all_configs):
    # Process the transcript file and insert anchor divs.
    output_lines = []
    mp_index = 0  # pointer into main_points_list
    ...
    # Format speaker names and convert timestamp-only lines into clickable links.
